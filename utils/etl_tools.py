...
class ETLTools:
    ...
    def extract_load(self,url:str, output_folder:str, format:str):
        ...
        DestinationFolder= project_root /"data"/"ETL"/output_folder
        ...
        try:
            ...
            data  = response.json()
            filename=DestinationFolder/f"extracted_data.{format}"
    ...
    def transform_load_context(self, file_path1:str):
        """
        ...
        file_path=path/"data"/"ETL"/file_path1
        file_extension = os.path.splitext(file_path)[1].lower()
        print(f"File extenstion: {file_extension}")
        try:
            ...
            print("Unable to read file from the given path")
